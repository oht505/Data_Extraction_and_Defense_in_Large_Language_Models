...
def main():
    ...
    nano_dp = load_nano_model("chkpt/nano/dp-sgd/checkpoint-60000.pt", dp=True)
    gpt2, gpt2_tok = load_gpt2_model("chkpt/large/plain/checkpoint-264000")
    gpt2_dp, gpt2_dp_tok = load_gpt2_model("chkpt/large/dp-sgd/checkpoint-264000")
